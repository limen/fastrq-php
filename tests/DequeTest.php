...
class DequeTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->queue->isCommandCached('deque_push_front'));
        $this->assertTrue($this->queue->isCommandCached('deque_pop_front'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_front_not_in'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_front_ne'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_front_ae'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_back'));
        $this->assertTrue($this->queue->isCommandCached('deque_pop_back'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_back_not_in'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_back_ne'));
        $this->assertTrue($this->queue->isCommandCached('deque_push_back_ae'));
    }
}